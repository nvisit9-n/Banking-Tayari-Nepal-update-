...
import { isOwnerAdmin, PRIMARY_OWNER_EMAIL, BACKUP_ADMIN_EMAIL } from '../../utils/sanitizer';
...
export const AdminAnalyticsDashboard: React.FC = () => {
  ...
  }, [registeredUsers, examRecords, notesActivities]);
  ...
  }, [examRecords, searchQuery, selectedQuizFilter, scoreFilter, dateFilter]);
          ...
          <div className="p-3 sm:p-4 border-b border-slate-200 dark:border-slate-800 bg-slate-50/70 dark:bg-slate-900/50 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            ...
            <div className="relative w-full md:w-80">
              ...
              <input
                ...
                placeholder="नाम वा इमेल खोज्नुहोस् (Search student)..."
